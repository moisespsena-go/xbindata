...
func nextSuffix() string {
	...
	rand = r
	randmu.Unlock()
	return strconv.Itoa(int(1e9 + r%1e9))[1:] + "-" + strconv.Itoa(os.Getpid())
}

// TempFile creates a new temporary file name in the directory dir with a name
...
func TempFile(dir, prefix string, suffix string) (pth string, err error) {
	if dir == "" {
		dir = os.TempDir()
	}
